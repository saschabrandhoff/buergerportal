 ...
 */
$GLOBALS['TL_DCA']['tl_module']['palettes']['bp_ideen_liste']    = '{title_legend},name,headline,type;{config_legend},jumpTo;{expert_legend:hide},cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['bp_ideen_katlist']    = '{title_legend},name,headline,type;{config_legend},jumpTo;{expert_legend:hide},cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['bp_ideen_start']    = '{title_legend},name,headline,type;{config_legend},jumpTo;{expert_legend:hide},cssID,space';
...
#acquistoShop_zustand,acquistoShop_hersteller,acquistoShop_produkttype,
